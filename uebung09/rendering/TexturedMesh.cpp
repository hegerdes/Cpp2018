...
{
    // // Delete all material face lists
...
void TexturedMesh::render()
{
    ...
    for(matListIt = m_matFaceLists.begin(); matListIt != m_matFaceLists.end(); matListIt++)
    {
        ...
        while(matFaceIt != matList->m_faces.end())
        {
            ...
            // std::cout << "VA: " 
            //           << m_vertexBuffer[a_pos    ] << " " 
            //           << m_vertexBuffer[a_pos + 1] << " " 
            //           << m_vertexBuffer[a_pos + 2] << " | "
            //           << m_normalBuffer[a_pos    ] << " " 
            //           << m_normalBuffer[a_pos + 1] << " " 
            //           << m_normalBuffer[a_pos + 2] << " | "
            //           << m_textureCoords[ta] << " "  << m_textureCoords[ta + 1] << endl << endl;
