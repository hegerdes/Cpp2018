...
float Matrix::operator[](const int& index) const
{
    ...
    {
        throw std::invalid_argument("Matrix array index out of bounds");
    }
    
}

float& Matrix::MatrixProxy::operator[](const int& index)
{
    if(index >= 0 && index <= 3)
    {
        return m_ptr[index];
    ...
    {
        throw std::invalid_argument("Matrix row index out of bounds");
    }
}

Matrix::MatrixProxy Matrix::operator[](const int& index)
{
    if(index < 4)
    {
        return MatrixProxy(&m[4 * index]);
    }
    else
    {
        throw std::invalid_argument("Matrix column index out of bounds");
    }
