...
void Renderable3D::move()
{
    m_position = m_position + m_direction * m_speed;
}

void Renderable3D::move(MoveTransform axis)
{
   move(axis, m_speed);
}


void Renderable3D::rotate(RotationTransfrom axis)
{
    rotate(axis, m_rotationSpeed);
}

void Renderable3D::rotate(RotationTransfrom axis, float s)
{
...
void Renderable3D::move(MoveTransform axis, float speed)
{
